...
- Текущий playable-контракт задают `Docs/Product/ProductDirection.md`, `Docs/Product/ExperienceDirection.md`, `Docs/Product/ProductValidationPlan.md` и `Docs/Product/DungeonExpeditionVerticalSliceGDD.md`; соответствующий текущий design — `Docs/Technical/DungeonExpeditionVerticalSliceTechnicalDesign.md`.
...
| --- | --- | --- |
| `Bootstrap`, application composition, root главного меню | `Docs/AI/architecture.md`, `Docs/AI/lifecycle.md`, `Docs/AI/libraries/lightdi.md`, `Docs/AI/libraries/roots-and-disposal.md` | `Docs/Technical/ProjectArchitectureTechnicalDesign.md` — изменение общей модульной архитектуры; UI-маршрут — изменение UI MainMenu |
