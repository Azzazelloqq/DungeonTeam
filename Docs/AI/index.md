...
| `Contracts`, contract acceptance/completion/save/reward claim | `Docs/AI/architecture.md`, `Docs/AI/lifecycle.md`, `Docs/AI/module-rules.md`, `Docs/AI/libraries/persistence.md`, `Docs/AI/libraries/config.md`, `Docs/Product/ContractGDD.md`, `Docs/Technical/ContractTechnicalDesign.md`, `Docs/Technical/ContractRewardTechnicalDesign.md` | `Docs/AI/testing.md` — state/migration behavior; route `GuildHall` — Board and neutral collection consumer; route `DungeonRun` — terminal result boundary; route `PlayerProfile` — idempotent banking; Unity validation — existing board/profile prefab bindings |
| `Quests`, quest acceptance/progress/completion/save/reward claim | `Docs/AI/architecture.md`, `Docs/AI/lifecycle.md`, `Docs/AI/module-rules.md`, `Docs/AI/libraries/persistence.md`, `Docs/AI/libraries/config.md`, `Docs/Product/QuestGDD.md`, `Docs/Technical/QuestTechnicalDesign.md`, `Docs/Technical/QuestRewardClaimTechnicalDesign.md` | `Docs/AI/testing.md` — state/migration behavior; route `GuildHall` — Board, reception/NPC claim surfaces and dialogue completion; route `DungeonRun` — settled terminal-result boundary; route `PlayerProfile` — idempotent banking; Unity validation — board/profile prefab bindings |
