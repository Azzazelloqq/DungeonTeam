...
| --- | --- | --- |
| `quest.clear-crypt` | Successfully complete `dungeon.crypt` | `0/1` → completed |
| `quest.crystal-supply` | Receive three `resource.monster-crystal` through settled expedition results | `0/3`, `1/3`, … → completed |
